...
<body class="bg-void text-moon flex h-screen overflow-hidden font-sans">
    ...
    <aside id="sidebar" class="fixed md:relative w-64 h-full bg-void border-r border-surface flex flex-col shadow-2xl z-50 transform -translate-x-full md:translate-x-0 sidebar-transition">
        ...
        <nav class="p-4 space-y-2 flex-1 overflow-y-auto">
            ...
            <a href="#" class="flex items-center gap-3 p-3 rounded-lg hover:bg-surface text-dim hover:text-gold transition text-sm font-medium">
                <i class="fas fa-cart-plus w-5"></i> Tambah Pesanan
            </a>
            <a href="#" class="flex items-center gap-3 p-3 rounded-lg hover:bg-surface text-dim hover:text-gold transition text-sm">
        ...
        <div class="flex-1 overflow-y-auto p-4 md:p-8 pb-20">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                <div class="bg-surface p-4 rounded-xl border border-white/5 shadow-xl">
                    <p class="text-[9px] md:text-[10px] text-dim uppercase tracking-widest font-bold mb-1">Omzet</p>
                    <p class="text-lg md:text-2xl font-bold text-gold font-mono">Rp 1.2M</p>
                </div>
                <div class="bg-surface p-4 rounded-xl border border-white/5 shadow-xl">
                    <p class="text-[9px] md:text-[10px] text-dim uppercase tracking-widest font-bold mb-1">Total</p>
                    <p class="text-lg md:text-2xl font-bold text-moon font-mono">24 <span class="text-xs text-dim">Nota</span></p>
                </div>
                </div>
            ...
            <div class="bg-surface rounded-2xl border border-white/5 overflow-hidden shadow-2xl">
                <div class="p-4 md:p-6 border-b border-white/5 bg-void/20 flex justify-between items-center">
                    ...
                    <a href="#" class="bg-gold text-void px-3 py-2 md:px-5 rounded-lg text-[9px] md:text-[10px] font-bold uppercase tracking-widest hover:bg-white transition shadow-lg">
                    ...
                    <table class="w-full text-left text-sm whitespace-nowrap">
                        <thead>
                            <tr class="text-[10px] text-dim uppercase tracking-widest border-b border-white/5 bg-void/50 font-bold">
                                ...
                                <th class="px-4 py-4 md:px-6">Status</th>
                                <th class="px-4 py-4 md:px-6 text-right">Aksi</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-white/5">
                            <tr class="hover:bg-white/[0.02] transition">
                                <td class="px-4 py-4 md:px-6 font-mono text-gold text-xs">#001</td>
                                <td class="px-4 py-4 md:px-6">Azka</td>
                                <td class="px-4 py-4 md:px-6 text-yellow-500 text-xs uppercase tracking-wider">Cooking</td>
                                <td class="px-4 py-4 md:px-6 text-right">
                                    <button class="text-dim hover:text-white"><i class="fas fa-ellipsis-v"></i></button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
