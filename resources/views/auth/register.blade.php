<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <button type="button" onclick="toggleRegPassword('password', 'eyeOpen1', 'eyeClosed1')" 
        ...
        <div>
            ...
            <div class="relative">
                ...
                <button type="button" onclick="toggleRegPassword('password_confirmation', 'eyeOpen2', 'eyeClosed2')" 
                        class="absolute right-4 top-1/2 transform -translate-y-1/2 text-white/50 hover:text-white transition-all duration-300 focus:outline-none hover:scale-110">
    ...
    <script>
        function toggleRegPassword(inputId, openId, closedId) {
